    ...
    <div className="col-md-12">
        <div className="card regular-table-with-color">
            <div className="card-header page-header ">
               <div className="page-titile-content" > <h4 className="card-title">SubscribeList</h4>
...
const connectedSubscribeList = connect(mapStateToProps)(SubscribeList);
export { connectedSubscribeList as SubscribeList };